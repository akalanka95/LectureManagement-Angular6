(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs'), require('@angular/router'), require('chart.js'), require('tslib')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs', '@angular/router', 'chart.js', 'tslib'], factory) :
	(factory((global['angular-bootstrap-md'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.Rx,global.ng.router,global.Chart,global.tslib));
}(this, (function (exports,core,common,forms,rxjs,router,Chart,tslib) { 'use strict';
