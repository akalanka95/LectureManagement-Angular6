...
var AngularFireMessaging = (function () {
    function AngularFireMessaging(options, nameOrConfig, platformId, zone) {
        ...
        var tokenChanges = this.messaging.pipe(switchMap(function (messaging) { return new Observable(messaging.onTokenRefresh); }), runOutsideAngular(zone));
        this.tokenChanges = this.getToken.pipe(concat(tokenChanges));
        this.messages = this.messaging.pipe(switchMap(function (messaging) { return new Observable(messaging.onMessage); }), runOutsideAngular(zone));
