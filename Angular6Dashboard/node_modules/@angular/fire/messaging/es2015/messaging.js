...
export class AngularFireMessaging {
    constructor(options, nameOrConfig, platformId, zone) {
        ...
        const tokenChanges = this.messaging.pipe(switchMap(messaging => new Observable(messaging.onTokenRefresh)), runOutsideAngular(zone));
        this.tokenChanges = this.getToken.pipe(concat(tokenChanges));
        this.messages = this.messaging.pipe(switchMap(messaging => new Observable(messaging.onMessage)), runOutsideAngular(zone));
