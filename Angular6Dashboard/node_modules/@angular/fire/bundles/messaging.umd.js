(function (global, factory) {
    ...
    var AngularFireMessaging = (function () {
        function AngularFireMessaging(options, nameOrConfig, platformId, zone) {
            ...
            var tokenChanges = this.messaging.pipe(operators.switchMap(function (messaging) { return new rxjs.Observable(messaging.onTokenRefresh); }), fire.runOutsideAngular(zone));
            this.tokenChanges = this.getToken.pipe(operators.concat(tokenChanges));
            this.messages = this.messaging.pipe(operators.switchMap(function (messaging) { return new rxjs.Observable(messaging.onMessage); }), fire.runOutsideAngular(zone));
