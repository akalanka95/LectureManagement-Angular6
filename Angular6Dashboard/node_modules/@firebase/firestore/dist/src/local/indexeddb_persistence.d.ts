...
export declare class IndexedDbTransaction extends PersistenceTransaction {
    ...
    constructor(simpleDbTransaction: SimpleDbTransaction);
}
/**
...
export declare class IndexedDbPersistence implements Persistence {
    ...
    constructor(persistenceKey: string, clientId: ClientId, platform: Platform, queue: AsyncQueue, serializer: JsonProtoSerializer, synchronizeTabs: boolean);
    /**
    ...
    runTransaction<T>(action: string, requirePrimaryLease: boolean, transactionOperation: (transaction: PersistenceTransaction) => PersistencePromise<T>): Promise<T>;
    /**
